...
python3 img_process.py  --img_scale 1 --image_dir $DATASET_PATH/images/ --image_resize_dir $DATASET_PATH/colmap/images/
...
/usr/local/bin/OpenMVS/TextureMesh scene_dense_mesh_refine.mvs --export-type obj --decimate 0.5 --cost-smoothness-ratio 5 
